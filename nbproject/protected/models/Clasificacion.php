...
class Clasificacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ID, NOMBRE, AGRUPACION, UNIDAD, ACTIVO', 'required'),
			array('AGRUPACION, UNIDAD', 'numerical', 'integerOnly'=>true),
			...
			array('ID, NOMBRE, AGRUPACION, UNIDAD, ACTIVO, CREADO_POR, CREADO_EL, ACTUALIZADO_POR, ACTUALIZADO_EL', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('AGRUPACION',$this->AGRUPACION);
