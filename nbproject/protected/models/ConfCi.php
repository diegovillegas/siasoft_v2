...
class ConfCi extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'NOMBRE_CLASIF_5' => '5:',
			'NOMBRE_CLASIF_6' => '6:',
			'INTEGRACION_CONTA' => utf8_encode('Integración Contable'),
			'USA_CODIGO_BARRAS' => utf8_encode('Usa Código de Barras'),
			'LINEAS_MAX_TRANS' => utf8_encode('Número Máx Líneas:'),
			'USA_UNIDADES_DIST' => utf8_encode('Unidades de Distribución'),
			'ASISTENCIA_AUTOMAT' => utf8_encode('Asistencia Automática'),
