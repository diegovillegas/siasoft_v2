...
class ConfCiController extends SBaseController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ConfCi']))
		{
			...
			if($valid)
				$model->EXIST_EN_TOTALES = implode(",",$model->EXIST_EN_TOTALES);
	...
	{
		$dataProvider=new CActiveDataProvider('ConfCi');
	...
	{
		$model=new ConfCi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ConfCi']))
			$model->attributes=$_GET['ConfCi'];
