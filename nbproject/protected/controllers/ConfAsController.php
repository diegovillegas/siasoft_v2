...
class ConfAsController extends SBaseController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('ConfAs');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['ConfAs']))
			$model->attributes=$_GET['ConfAs'];
