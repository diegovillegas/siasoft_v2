...
class CompaniaController extends SBaseController
{
	/**
	...
	/*public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','cargar'),
				'users'=>array('*'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Compania']))
		{
			...
			$model->TELEFONO1= $_POST['INDICATIVO1'].'-'.$_POST['Compania']['TELEFONO1'];
			$model->TELEFONO2= $_POST['INDICATIVO2'].'-'.$_POST['Compania']['TELEFONO2'];
