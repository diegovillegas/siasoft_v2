...
class NitController extends SBaseController
{
	...
	public function actionMascara() {
		$data=TipoDocumento::model()->findAll('ID="'.$_POST['Nit']['TIIPO_DOCUMENTO'].'"');
		foreach($data as $tipoDoc)
        {
			$mascara = $tipoDoc->MASCARA;
		}
				
		echo $this->widget('CMaskedTextField', array('model' => 'Nit','attribute' => 'ID', 'name' => 'ID', 'mask' => $mascara), true);
