...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'CODIGO_ISO'); ?>
		<?php echo $form->textField($model,'CODIGO_ISO',array('size'=>4,'maxlength'=>4)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'ACTUALIZADIO_EL'); ?>
		<?php echo $form->textField($model,'ACTUALIZADIO_EL'); ?>
	</div>
