...
$this->breadcrumbs=array(
	'Clasificacion Adi Valors'=>array('index'),
	'Administrar',
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('clasificacion-adi-valor-grid', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
<h1>Clasificacion Adicional Valor</h1>
...
<?php 
	...
	<div class="modal-header">
		...
		<h3>Crear Clasificacion Adicional Valor</h3>
