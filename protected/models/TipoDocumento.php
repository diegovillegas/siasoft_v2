...
class TipoDocumento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('MASCARA, CREADO_POR, ACTUALIZADO_POR', 'length', 'max'=>20),
			array('ACTIVO', 'length', 'max'=>1),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ID, DESCRIPCION, MASCARA, ACTIVO, CREADO_POR, CREADO_EL, ACTUALIZADO_POR, ACTUALIZADO_EL', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'nits' => array(self::HAS_MANY, 'Nit', 'TIIPO_DOCUMENTO'),
		);
	}
