...
<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm', array(
	...
	<?php $this->widget('bootstrap.widgets.BootButton', array('label'=>'Cancelar', 'size'=>'small',	'url' => array('/tipoDocumento/admin'), 'icon' => 'remove', 'htmlOptions'=>array('data-dismiss'=>'modal')));  ?>	        
        </div>
