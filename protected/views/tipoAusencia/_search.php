...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'TIPO_AUSENCIA'); ?>
		<?php echo $form->textField($model,'TIPO_AUSENCIA'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'JUSTIFICADA'); ?>
		<?php echo $form->textField($model,'JUSTIFICADA',array('size'=>1,'maxlength'=>1)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'PAGO'); ?>
		<?php echo $form->textField($model,'PAGO',array('size'=>1,'maxlength'=>1)); ?>
	</div>
