<?php
if($model!==null){ 
$labels = new UbicacionGeografica1?>
...
<table border="1">
    <tr>    
        <th> <?php echo $labels->getAttributeLabel('ID')?></th>
        <th> <?php echo $labels->getAttributeLabel('PAIS')?></th>
    ...
    <tr>
        ...
        <td <?php echo ($x)%2==0 ?"style='background-color:#CCC'":""?>><?php echo$value->PAIS?></td>
