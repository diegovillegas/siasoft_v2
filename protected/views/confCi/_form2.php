			...
			'tabs'=>array(
				...
				array(
					...
					'content'=>
						...
						$form->checkBoxRow($model, 'ASISTENCIA_AUTOMAT',array('disabled'=>$model->USA_CODIGO_BARRAS ? false : true ))
						.'<fieldset style="width: 430px; float: left;">
							...
							<table>
								...
								<tr>
									<td>'.$form->checkBoxRow($model, 'USA_CODIGO_EAN13',array('disabled'=>$model->USA_CODIGO_BARRAS ? false : true)).'</td>
									<td>'
										.$form->textField($model, 'EAN13_REGLA_LOCAL',array('disabled'=>$model->ASISTENCIA_AUTOMAT ? false : true,'size'=>3,'maxlength'=>3,'value'=>$regla1))
										.' - '.CHtml::textField('PRODUCTO_EAN13',$regla2,array('disabled'=>$model->ASISTENCIA_AUTOMAT ? false : true,'size'=>5,'maxlength'=>5))
								  .'</td>
								    <tr>
										<td></td>
								...
								<tr>
									<td>'.$form->checkBoxRow($model, 'USA_CODIGO_EAN8',array('disabled'=>$model->USA_CODIGO_BARRAS ? false : true)).'</td>
									<td>'
										.$form->textField($model,'EAN8_REGLA_LOCAL',array('disabled'=>$model->ASISTENCIA_AUTOMAT ? false : true,'size'=>3,'maxlength'=>3))
								  .'</td>
								</tr>
								<tr>
										<td></td>
								...
								<tr>
									<td>'.$form->checkBoxRow($model, 'USA_CODIGO_UCC12',array('disabled'=>$model->USA_CODIGO_BARRAS ? false : true)).'</td>
									<td>'
										.$form->textField($model,'UCC12_REGLA_LOCAL',array('disabled'=>$model->ASISTENCIA_AUTOMAT ? false : true,'size'=>1,'maxlength'=>1, 'value'=>$regla3))
										.' - '.CHtml::textField('PRODUCTO_UCC12', $regla4,array('disabled'=>$model->ASISTENCIA_AUTOMAT ? false : true,'size'=>5,'maxlength'=>5,))
								  .'</td>
								</tr>
								<tr>
										<td></td>
								...
								<tr>
								<tr>
									<td>'.$form->checkBoxRow($model, 'USA_CODIGO_UCC8',array('disabled'=>$model->USA_CODIGO_BARRAS ? false : true)).'</td>
									<td></td>
								</tr>
