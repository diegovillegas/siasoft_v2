                            ...
                            'tabs'=>array(
                                array(
                                    ...
                                    'content'=>
                                        ...
                                        .$form->dropDownListRow($model2,'FORMATO_IMPRESION',CHtml::listData(FormatoImpresion::model()->findAllByAttributes(array('MODULO'=>'COIN')), 'ID', 'NOMBRE'),array('empty'=>'Seleccione'))
                                    ,   
                                    'active'=>true
                                ),
                                array(
