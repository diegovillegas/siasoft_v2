<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('CODIGO_CATALOGO')); ?>:</b>
	<?php echo CHtml::encode($data->CODIGO_CATALOGO); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('NOMBRE_CATALOGO')); ?>:</b>
	<?php echo CHtml::encode($data->NOMBRE_CATALOGO); ?>
	<br />
