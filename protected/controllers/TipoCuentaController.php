...
class TipoCuentaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TipoCuenta'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->TIPO_CUENTA));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('TipoCuenta');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['TipoCuenta']))
			$model->attributes=$_GET['TipoCuenta'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-cuenta-form')
		{
