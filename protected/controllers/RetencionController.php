...
class RetencionController extends SBaseController
{
	/**
...
*/
	...
	{
		$dataProvider=new CActiveDataProvider('Retencion');
	...
	{
		$model=Retencion::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='retencion-form')
		{
