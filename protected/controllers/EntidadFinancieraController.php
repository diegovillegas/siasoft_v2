...
class EntidadFinancieraController extends SBaseController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('EntidadFinanciera');
	...
	{
		$model=EntidadFinanciera::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='entidad-financiera-form')
		{
