...
class CodicionPagoController extends SBaseController
{
	/**
	...
	{
		$model= CodicionPago::model()->findAll();
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['CodicionPago']))
			$model->attributes=$_GET['CodicionPago'];
	...
	{
		$model=CodicionPago::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='codicion-pago-form')
		{
