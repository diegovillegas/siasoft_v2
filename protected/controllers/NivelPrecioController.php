...
class NivelPrecioController extends SBaseController
{
	/**
...
public function actionPdf(){
	...
	{
		$model=NivelPrecio::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='nivel-precio-form')
		{
